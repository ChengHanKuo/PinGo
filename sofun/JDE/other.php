...
$sql="SELECT * FROM menu WHERE type='其他'";
$result=mysqli_query($link,$sql);
echo "<form action='otherok.php' method='post'>";
echo "<table border='1'>";
echo "<tr><td>名稱</td><td>火/烤</td><td>份數</td></tr>";
