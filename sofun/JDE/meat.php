...
$sql="SELECT * FROM menu WHERE type='肉類'";
$result=mysqli_query($link,$sql);

echo "<form action='meatok.php' method='post'>";
echo "<table border='1'>";
echo "<p class='ff'><tr><td>名稱</td><td>火/烤</td><td>份數</td></tr>";
